            ...
            <div class="modal-content">
                ...
                <form action="{{ route('hapus-transaksi') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="jenis_hapus" id="jenisHapus" value="pembelian">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            buatLaporan.addEventListener('click', (e) => {
                ...
                console.log(`tanggal: ${tanggal.value.substr(0, 10)}`);
                let printStruk = window.open(
                    `${globalUrl}laporan-harian-pembelian/?tanggal=${tanggal.value.substr(0, 10)}`
                );
            });
