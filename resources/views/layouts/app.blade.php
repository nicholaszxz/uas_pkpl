...
<head>
    ...
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('assets/favicon/ahs/apple-icon-152x152.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/favicon/ahs/apple-icon-180x180.png') }}">
    ...
    <title>{{ config('app.name', 'AHS Asean Pasifik') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Ahs Asean Pasifik') }}
                </a>
